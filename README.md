...
Банк содержит одно мнение о том, что должно прозвучать в сильном ответе — моё.
Твоя формулировка обычно ближе к тому, как ты реально говоришь, и к твоим проектам,
поэтому её можно записать, и дальше сверка пойдёт с ней:
...
После каждого разбора тренажёр сам предлагает записать свою версию. Пункты пишутся
по одному в строке, маркеры и нумерация срезаются. Хранится в `data/my_answers.json`
(git-ignored, это личное). Банковский эталон никуда не девается — он по-прежнему
показывается под разбором, чтобы было с чем сверяться.

Смысл не в удобстве: момент, когда ты формулируешь ответ своими словами, и есть
момент запоминания.
